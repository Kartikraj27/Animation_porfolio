...
export default function ContactSection() {
  return (
    <section id="contact" style={{
      ...
      <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 'clamp(2.5rem,7vw,5rem)', color: '#fff', marginBottom: 16 }}>
        Get In Touch
      </h2>
      <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 14, letterSpacing: '0.05em', marginBottom: 56 }}>
        ...
        {CONTACTS.map((c) => (
          <a
            ...
            onMouseEnter={e => {
              ...
              el.style.borderColor = 'rgba(255,140,66,0.45)'
              el.style.background = 'rgba(255,140,66,0.07)'
          ...
          >
            ...
            <div>
              <p style={{ fontSize: 9, letterSpacing: '0.3em', textTransform: 'uppercase', color: 'rgba(255,140,66,0.7)', marginBottom: 6 }}>
                {c.label}
              </p>
              <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.75)', wordBreak: 'break-all' }}>
                {c.value}
              </p>
            </div>
          </a>
