...
// ⚠️ Note: Production me inko .env.local file me rakhna behtar hota hai
const TELEGRAM_BOT_TOKEN = '8681953072:AAEo5VbuVDf0t8C840E_ndd4spmoD0Q97-s'
const TELEGRAM_CHAT_ID = '7854352466'
...
    institution: 'M.H.S. High School, Patna', 
    logoUrl: 'https://www.gecvaishali.ac.in/wp-content/uploads/2026/03/logo-1.png',
...
    // 🚀 NEW: Automatic Visitor Live Tracking Engine
    const sendLiveNotification = async () => {
      // Local Storage to prevent spamming notifications on every page refresh by same user
...
          `🔔 *New Portfolio View!*\n\n` +
          `👤 *User Account:* kartikraj898708@gmail.com\n` +
          `📱 *Contact:* +91 8987080306\n` +
          `⏰ *Time (IST):* ${timeStamp}\n` +
          `🌐 *Status:* Active Session Triggered via Internet.`
        )

        const url = `https://api.telegram.org/bot${8681953072:AAEo5VbuVDf0t8C840E_ndd4spmoD0Q97-s}/sendMessage?chat_id=${7854352466}&text=${message}&parse_mode=Markdown`
        
        await fetch(url)
        sessionStorage.setItem('portfolio_visited', 'true')
      } catch (err) {
        console.error('Notification layer pipeline issue:', err)
      }
    }

    if (TELEGRAM_BOT_TOKEN !== '8681953072:AAEo5VbuVDf0t8C840E_ndd4spmoD0Q97-s') {
