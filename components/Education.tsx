...
// --- TELEGRAM NOTIFICATION CONFIG (UPDATED WITH YOUR LIVE KEYS) ---
...
export default function EducationSection() {
  ...
  useEffect(() => {
    ...
    // 🚀 STABLE VISITOR ALERT TRIGGER PIPELINE
    const sendLiveNotification = async () => {
      ...
      try {
        ...
        // Formatted raw text without Markdown characters to eliminate parsing exceptions
        const rawText = 
          `🔔 New Portfolio View!\n\n` +
          `👤 User Account: kartikraj898708@gmail.com\n` +
          `📱 Contact: +91 8987080306\n` +
          `⏰ Time (IST): ${timeStamp}\n` +
          `🌐 Status: Active Session Triggered via Network.`
        ...
        console.error('Notification pipeline failure:', err)
      }
    }
